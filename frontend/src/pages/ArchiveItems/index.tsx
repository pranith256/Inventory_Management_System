...
import { useGetAllArchiveItemsQuery } from '../../provider/queries/Items.query';
import Loader from '../../components/Loader';
import TableCard from './components/ArchiveItem.model';
...
//   const [visible, setVisible] = useState(false);
  ...
  const { isLoading, data , isFetching } = useGetAllArchiveItemsQuery({ query: SearchParams.get("query") || '', page: SearchParams.get("page")||1 });
  console.log(data);
  ...
  return (
    ...
    <>  
        ...
        <BredCrums PageLink='/archiveitems' PageName='Archived Items' /> 
      ...
      <form onSubmit={onSubmitHandler} className="mb-3 flex justify-end w-[90%] mx-auto">
        ...
        <input value={Search} onChange={(e:any) => setSearch(e.target.value)} className=" w-[90%] mx-auto lg:mx-0 lg:w-1/2 rounded-sm border py-3 px-5 outline-none " placeholder="Search Archived Item" />
